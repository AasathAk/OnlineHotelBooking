<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0 h-font">SEA BREAZE</h3>
    <a href="logout.php" class="btn btn-light btn-sm">LOG OUT</a>
</div>

<div class="col-lg-2 bg-dark border-top border-3 border-secondary fixed-left" id="dashboard-menu">
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <button class="btn text-white px-3 w-100 shadow-none text-start d-flex 
                        align-items-center justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#BookingLinks">
                            <span>Bookings</span>
                        ...
                        <div class="collapse show px-3 small mb-1" id="BookingLinks">
                            <ul class="nav nav-pills flex-column rounded border border-secondary">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="booking_records.php">Booking Record</a>
                                </li>
