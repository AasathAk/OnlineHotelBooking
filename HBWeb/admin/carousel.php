     ...
     <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden ">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-sm btn-dark shadow-none " data-bs-toggle="modal" data-bs-target="#carousel-set">
                ...
                <!-- Carousel modal -->
                <div class="modal fade" id="carousel-set" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
