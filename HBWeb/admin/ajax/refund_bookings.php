...
if (isset($_POST['get_bookings'])) {
    ...
    $res = select($query, [$searchParam, $searchParam, $searchParam, "cancelled", 0], 'sssss');
    ...
    while ($data = mysqli_fetch_assoc($res)) 
     {
        ...
        $table_data .= "
            <tr>
                ...
                <td><b>Rs: </b> $data[trans_amt]
                </td>
                <td>
                <button type='button' onclick='refund_booking($data[booking_id])' class='btn btn-sm fw-bold btn-outline-success mt-2'>
