            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden ">
                ...
                <div class="row mb-4">
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            ...
                            <h2 class="mt-2 mb-0" id="total_new_reg">0</h2>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            <h6>Queries</h6>
                            <h2 class="mt-2 mb-0" id="total_queries">0</h2>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            <h6>Reviews</h6>
                            <h2 class="mt-2 mb-0" id="total_reviews">0</h2>
                        </div>
                    </div>
                </div>
                <h5>Users</h5>
                <div class="row mb-4">
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            <h6>Total Users</h6>
                            <h2 class="mt-2 mb-0"><?php echo $current_users['total'] ?></h2>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            <h6>Active Users</h6>
                            <h2 class="mt-2 mb-0"><?php echo $current_users['active'] ?></h2>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            <h6>Inactive Users</h6>
                            <h2 class="mt-2 mb-0"><?php echo $current_users['inactive'] ?></h2>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            <h6>Unverified Users</h6>
                            <h2 class="mt-2 mb-0"><?php echo $current_users['unverified'] ?></h2>
                        </div>
                    </div>
                </div>
            </div>
