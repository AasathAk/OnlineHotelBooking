...
<head>
    ...
    <title>Sea breaze Hotel - Home</title>
        ...
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                echo <<<data
                        ...
                        <div class="col-lg-2 col-md-2 text-center bg-white shadow py-4 my-3 rounded  ">
                        <img src="$path$row[icon]" alt="" width="80px">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="bg-white p-4 rounded mb-4">
                    <h5>Call us</h5>
                    <a href="tel:+<?php $contact_r['pn1'] ?>" class="d-inline-block mb-3">
                        <span class="badge bg-light text-dark fs-6 p-2">
                            <i class="bi bi-telephone-fill me-1"></i> +<?php echo $contact_r['pn1']; ?></span>
                    </a>
                </div>
    ...
    var swiper = new Swiper(".swiper-testimonials", {
      ...
      breakpoints: {
        ...
        recovery_form.addEventListener('submit', function(e) {
            ...
            let data = new FormData(recovery_form);
